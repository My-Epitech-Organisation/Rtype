...
** R-Type
** File description:
** Rect - AABB (Axis-Aligned Bounding Box) structure for QuadTree
*/

#ifndef QUADTREE_RECT_HPP
    #define QUADTREE_RECT_HPP
...
namespace QuadTree {
    ...
    struct Rect {
         ...
         */
        [[nodiscard]] constexpr bool containsPoint(float px, float py) const noexcept {
