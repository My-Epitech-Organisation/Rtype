...
TEST_F(BinarySerializerTest, ReadUint8Success) {
    ...
    EXPECT_EQ(BinarySerializer::readUint8(buffer, offset), 0x00);
    EXPECT_EQ(BinarySerializer::readUint8(buffer, offset), 0xFF);
    EXPECT_EQ(BinarySerializer::readUint8(buffer, offset), 0x7F);
    EXPECT_EQ(offset, 3);
}
...
TEST_F(BinarySerializerTest, ReadUint16Success) {
    ...
    EXPECT_EQ(BinarySerializer::readUint16(buffer, offset), 0x1234);
    EXPECT_EQ(BinarySerializer::readUint16(buffer, offset), 0xFFFF);
    EXPECT_EQ(offset, 4);
}
...
TEST_F(BinarySerializerTest, ReadUint32Success) {
    ...
    EXPECT_EQ(BinarySerializer::readUint32(buffer, offset), 0x12345678);
    EXPECT_EQ(BinarySerializer::readUint32(buffer, offset), 0xFFFFFFFF);
    EXPECT_EQ(offset, 8);
}
...
TEST_F(BinarySerializerTest, ReadUint64Success) {
    ...
    EXPECT_EQ(BinarySerializer::readUint64(buffer, offset), 0x123456789ABCDEF0ULL);
    EXPECT_EQ(offset, 8);
}
...
TEST_F(BinarySerializerTest, ReadInt32Success) {
    ...
    int32_t val1 = BinarySerializer::readInt32(buffer, offset);
    int32_t val2 = BinarySerializer::readInt32(buffer, offset);
...
TEST_F(BinarySerializerTest, ReadFloatSuccess) {
    ...
    float val1 = BinarySerializer::readFloat(buffer, offset);
    float val2 = BinarySerializer::readFloat(buffer, offset);
...
TEST_F(BinarySerializerTest, ReadStringSuccess) {
    ...
    std::string result = BinarySerializer::readString(buffer, offset);
...
TEST_F(BinarySerializerTest, ReadUint8BufferOverflow) {
    ...
    EXPECT_THROW(BinarySerializer::readUint8(buffer, offset), std::out_of_range);
}
...
TEST_F(BinarySerializerTest, ReadUint16BufferOverflow) {
    ...
    EXPECT_THROW(BinarySerializer::readUint16(buffer, offset), std::out_of_range);
}
...
TEST_F(BinarySerializerTest, ReadUint32BufferOverflow) {
    ...
    EXPECT_THROW(BinarySerializer::readUint32(buffer, offset), std::out_of_range);
}
...
TEST_F(BinarySerializerTest, ReadUint64BufferOverflow) {
    ...
    EXPECT_THROW(BinarySerializer::readUint64(buffer, offset), std::out_of_range);
}
...
TEST_F(BinarySerializerTest, ReadStringBufferOverflowInLength) {
    ...
    EXPECT_THROW(BinarySerializer::readString(buffer, offset), std::out_of_range);
}
...
TEST_F(BinarySerializerTest, RoundTripUint8) {
    ...
    for (auto val : values) {
        ...
        EXPECT_EQ(BinarySerializer::readUint8(buffer, offset), val);
    }
}
...
TEST_F(BinarySerializerTest, RoundTripUint16) {
    ...
    for (auto val : values) {
        ...
        EXPECT_EQ(BinarySerializer::readUint16(buffer, offset), val);
    }
}
...
TEST_F(BinarySerializerTest, RoundTripUint32) {
    ...
    for (auto val : values) {
        ...
        EXPECT_EQ(BinarySerializer::readUint32(buffer, offset), val);
    }
}

TEST_F(BinarySerializerTest, RoundTripUint64) {
    uint64_t values[] = {0, 1, 0xFFFFFFFFULL, 0x7FFFFFFFFFFFFFFFULL, 0xFFFFFFFFFFFFFFFFULL};
    for (auto val : values) {
        buffer.clear();
        offset = 0;
        BinarySerializer::writeUint64(buffer, val);
        EXPECT_EQ(BinarySerializer::readUint64(buffer, offset), val);
    }
}
...
TEST_F(BinarySerializerTest, RoundTripInt32) {
    ...
    for (auto val : values) {
        ...
        EXPECT_EQ(BinarySerializer::readInt32(buffer, offset), val);
    }
}
...
TEST_F(BinarySerializerTest, RoundTripFloat) {
    ...
    for (auto val : values) {
        ...
        EXPECT_FLOAT_EQ(BinarySerializer::readFloat(buffer, offset), val);
    }
}
...
TEST_F(BinarySerializerTest, RoundTripString) {
    ...
    for (const auto& val : values) {
        ...
        EXPECT_EQ(BinarySerializer::readString(buffer, offset), val);
    }
}
...
TEST_F(BinarySerializerTest, MultipleValuesSequential) {
    ...
    EXPECT_EQ(BinarySerializer::readUint8(buffer, offset), 42);
    EXPECT_EQ(BinarySerializer::readUint16(buffer, offset), 1234);
    EXPECT_EQ(BinarySerializer::readUint32(buffer, offset), 567890);
    EXPECT_EQ(BinarySerializer::readInt32(buffer, offset), -9999);
    EXPECT_FLOAT_EQ(BinarySerializer::readFloat(buffer, offset), 1.5f);
    EXPECT_EQ(BinarySerializer::readString(buffer, offset), "test");
}
...
TEST_F(BinarySerializerTest, OffsetIncrementCorrectly) {
    ...
    BinarySerializer::readUint8(buffer, offset);
    expectedOffset += 1;
    EXPECT_EQ(offset, expectedOffset);

    BinarySerializer::readUint16(buffer, offset);
    expectedOffset += 2;
    EXPECT_EQ(offset, expectedOffset);

    BinarySerializer::readUint32(buffer, offset);
    expectedOffset += 4;
    EXPECT_EQ(offset, expectedOffset);

    BinarySerializer::readUint64(buffer, offset);
    expectedOffset += 8;
    EXPECT_EQ(offset, expectedOffset);
}
