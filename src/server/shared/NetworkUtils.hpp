...
// Ensure Winsock is initialized on Windows. Returns true on success or
// non-Windows platforms. Use this before calling low-level socket APIs in tests
// that run on Windows to allow skipping tests cleanly if initialization fails.
