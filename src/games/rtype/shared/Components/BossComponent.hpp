 ...
 */
[[nodiscard]] const char* bossAttackPatternToString(
 ...
 * @return String representation
 */
[[nodiscard]] const char* bossTypeToString(BossType type) noexcept;
 ...
 */
[[nodiscard]] BossAttackPattern stringToBossAttackPattern(
 ...
 */
[[nodiscard]] BossType stringToBossType(const std::string& str) noexcept;
