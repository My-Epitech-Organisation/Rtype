...
#ifndef SRC_GAMES_RTYPE_SHARED_CONFIG_RTYPEGAMESTATE_HPP_
#define SRC_GAMES_RTYPE_SHARED_CONFIG_RTYPEGAMESTATE_HPP_
...
#endif  // SRC_GAMES_RTYPE_SHARED_CONFIG_RTYPEGAMESTATE_HPP_
