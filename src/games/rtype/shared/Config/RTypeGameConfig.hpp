...
#ifndef SRC_GAMES_RTYPE_SHARED_CONFIG_RTYPEGAMECONFIG_HPP_
#define SRC_GAMES_RTYPE_SHARED_CONFIG_RTYPEGAMECONFIG_HPP_
...
#endif  // SRC_GAMES_RTYPE_SHARED_CONFIG_RTYPEGAMECONFIG_HPP_
