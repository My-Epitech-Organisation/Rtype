...
void BinarySerializer::writeUint8(std::shared_ptr<std::vector<uint8_t>> buffer,
                                  uint8_t value) {
    buffer->push_back(value);
}

void BinarySerializer::writeUint16(std::shared_ptr<std::vector<uint8_t>> buffer,
                                   uint16_t value) {
    buffer->push_back(static_cast<uint8_t>(value & 0xFF));
    buffer->push_back(static_cast<uint8_t>((value >> 8) & 0xFF));
}

void BinarySerializer::writeUint32(std::shared_ptr<std::vector<uint8_t>> buffer,
                                   uint32_t value) {
    buffer->push_back(static_cast<uint8_t>(value & 0xFF));
    buffer->push_back(static_cast<uint8_t>((value >> 8) & 0xFF));
...
void BinarySerializer::writeUint64(std::shared_ptr<std::vector<uint8_t>> buffer,
                                   uint64_t value) {
    for (int i = 0; i < 8; ++i) {
...
void BinarySerializer::writeInt32(std::shared_ptr<std::vector<uint8_t>> buffer,
                                  int32_t value) {
    writeUint32(buffer, static_cast<uint32_t>(value));
}

void BinarySerializer::writeFloat(std::shared_ptr<std::vector<uint8_t>> buffer,
                                  float value) {
    uint32_t intVal;
...
void BinarySerializer::writeString(std::shared_ptr<std::vector<uint8_t>> buffer,
