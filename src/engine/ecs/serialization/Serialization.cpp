...
namespace ECS {
    ...
    auto Serializer::loadFromFile(const std::string& filename, bool clearExisting) -> bool {
    ...
    auto Serializer::deserialize(const std::string& data, bool clearExisting) -> bool {
