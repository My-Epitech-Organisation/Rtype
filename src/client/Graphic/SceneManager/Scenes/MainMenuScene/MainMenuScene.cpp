...
{
    this->_assetsManager->fontManager->load("title_font", Audiowide_Regular_ttf, Audiowide_Regular_ttf_len);
    ...
    this->_registry->emplaceComponent<Image>(background, this->_assetsManager->textureManager->get("bg_menu"), sf::IntRect{{0, 0}, {0, 0}});
    this->_registry->emplaceComponent<Position>(background, 0, 0);

    auto appTitle = this->_registry->spawnEntity();
    this->_registry->emplaceComponent<Text>(appTitle, this->_assetsManager->fontManager->get("title_font"), sf::Color::White, 72, "R-TYPE");
    ...
    this->_listEntity.push_back(EntityFactory::createButton(
        *this->_registry,
        Text(this->_assetsManager->fontManager->get("title_font"), sf::Color::White, 36, "Start Game"),
        Position(100, 350),
    ...
    this->_listEntity.push_back(EntityFactory::createButton(
        *this->_registry,
        Text(this->_assetsManager->fontManager->get("title_font"), sf::Color::White, 36, "Settings"),
        Position(100, 460),
        Rectangle({400, 75}, sf::Color::Blue, sf::Color::Red),
        std::function<void()>([switchToScene]() {
            try {
    ...
    this->_listEntity.push_back(EntityFactory::createButton(
        *this->_registry,
        Text(this->_assetsManager->fontManager->get("title_font"), sf::Color::White, 36, "Quit"),
        Position(100, 570),
        Rectangle({400, 75}, sf::Color::Blue, sf::Color::Red),
