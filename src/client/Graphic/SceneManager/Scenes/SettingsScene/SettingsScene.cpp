...
static void createSection(std::shared_ptr<ECS::Registry> registry,
...
void SettingsScene::_initKeybindSection() {
    ...
    float sectionW = 600;
    float sectionH = 600;
    createSection(this->_registry, this->_assetsManager, this->_listEntity,
            ...
            *this->_registry,
            ...
            std::function<void()>([this, action]() {
                ...
                if (this->_registry->hasComponent<Text>(entity)) {
                    ...
                    std::string waitText =
                        actionToString(action) + ": Press any key...";
...
void SettingsScene::pollEvents(const sf::Event& e) {
    if (this->_actionToRebind.has_value()) {
        if (const auto* keyEvent = e.getIf<sf::Event::KeyPressed>()) {
            ...
            std::string text =
                actionToString(*this->_actionToRebind) + ": " + keyName;
