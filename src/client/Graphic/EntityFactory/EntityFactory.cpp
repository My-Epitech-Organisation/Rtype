...
std::vector<ECS::Entity> EntityFactory::createBackground(
    ...
    registry->emplaceComponent<BackgroundTag>(background);
    ...
    registry->emplaceComponent<BackgroundTag>(planet1);
    ...
    registry->emplaceComponent<BackgroundTag>(planet2);
    ...
    registry->emplaceComponent<BackgroundTag>(planet3);
    ...
    registry->emplaceComponent<BackgroundTag>(appTitle);
