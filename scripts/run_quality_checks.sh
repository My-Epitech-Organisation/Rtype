...
if [ ! -f "$CPPLINT_SCRIPT" ]; then
    ...
    CPPLINT_FILTERS="--filter=-whitespace/parens,-legal/copyright,-whitespace/indent,-whitespace/line_length,-build/include_subdir,-build/c++11,-runtime/references,-build/include_what_you_use,-build/include_order"
